...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/student/profile" element={<ProtectedRoute allowedRole="student"><ComingSoon title="Student Profile" /></ProtectedRoute>} />
      ...
      <Route path="/recruiter/jobs" element={<ProtectedRoute allowedRole="recruiter"><ComingSoon title="My Job Listings" /></ProtectedRoute>} />
      <Route path="/recruiter/applicants" element={<ProtectedRoute allowedRole="recruiter"><ComingSoon title="All Applicants" /></ProtectedRoute>} />
      ...
      <Route path="/admin/jobs" element={<ProtectedRoute allowedRole="admin"><ComingSoon title="Job Management" /></ProtectedRoute>} />
